package com.milesight.beaveriot.integration.lavatory.util
...
class LavatoryTslUtilsTest extends Specification {
    ...
    def "given thing spec when calling getPropertiesEntities then should return property entities"() {
        ...
        when:
        def result = LavatoryTslUtils.getPropertiesEntities("", "", thingSpec)
