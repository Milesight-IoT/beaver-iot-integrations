...
import static com.milesight.beaveriot.parser.plugin.HardwareVersionPlugIn.readVersion;
import static com.milesight.beaveriot.parser.util.PlugInUtil.*;

/**
 * @Description: 固件版本插件
 */
@PlugInType(id = "firmware_version", channel = 0xff, type = 0x0a, snMark = {})
public class FirmwareVersionPlugIn implements PlugIn {
